...
from nemo_rl.data.hf_datasets.gsm8k import GSM8KDataset
...
def setup_data(
    ...
    elif data_config["dataset_name"] == "gsm8k":
        print("Loading openai/gsm8k for training and validation")
        data: Any = GSM8KDataset(seed=seed)
    else:
